...
const AddToPlaylistDialog = ({ songId, trigger, open: controlledOpen, onOpenChange }: AddToPlaylistDialogProps) => {
  ...
  // If controlled mode (no trigger), render without DialogTrigger
  if (isControlled) {
    return (
