...
const Sidebar = () => {
    ...
    return (
      <>
        <Button
          variant="ghost"
          size="icon"
          className="fixed top-4 left-4 z-50 bg-sidebar/90 backdrop-blur-sm"
        ...
        <aside
          className={cn(
            "fixed top-0 left-0 w-64 bg-sidebar h-screen flex flex-col border-r border-sidebar-border z-50 transition-transform duration-300",
            ...
            {user ? (
              <>
                ...
                <Button
                  ...
                  className="w-full justify-start gap-3 px-3 text-muted-foreground hover:text-foreground text-sm"
                >
  ...
  // Desktop Sidebar
  return (
    <aside className="w-72 bg-sidebar h-screen flex flex-col border-r border-sidebar-border">
      <div className="p-6">
      ...
      <div className="p-5 border-t border-sidebar-border space-y-3">
        {user ? (
          <>
            <Link
              to="/profile"
              className="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-sidebar-accent/50 transition-all duration-200"
            >
            ...
            <Button
              variant="ghost"
              onClick={handleSignOut}
              className="w-full justify-start gap-4 px-4 text-muted-foreground hover:text-foreground"
            >
